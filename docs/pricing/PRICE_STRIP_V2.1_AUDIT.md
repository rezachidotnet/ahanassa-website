...
1. Does a real "AHANASSA HOMEPAGE PRICE STRIP — FROZEN V2.1" document exist outside this repository? If so, it should be added to `docs/pricing/` so future audits/implementation can reference it directly rather than a task-prompt paraphrase.
