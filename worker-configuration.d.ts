/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./worker-configuration.d.ts` (hash: c98e50f31dff0e85d210794d40492e4f)
// Runtime types generated with workerd@1.20260825.1 2026-08-26 
interface __BaseEnv_CloudflareEnv {
	DB_OPS: D1Database;
	DB_PUBLIC: D1Database;
	ODOO_SYNC_QUEUE: Queue;
	RFQ_RATE_LIMITER: RateLimit;
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/entry");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ODOO_BASE_URL" | "ODOO_DATABASE" | "ODOO_CRM_TEAM_ID" | "NEXT_PUBLIC_TURNSTILE_SITE_KEY" | "PRICE_STRIP_ENABLED" | "ENABLED_PRICE_PROVIDERS" | "HOMEPAGE_RANKING_MODE">> {}
}
