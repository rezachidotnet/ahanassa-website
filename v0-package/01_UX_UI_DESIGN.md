...
For the homepage/header, the primary conversion action is **ارسال لیست خرید**. The secondary outlined action is **آشنایی با فرآیند خرید**; **تماس با ما** remains the normal support/navigation item. Do not use screenshot wording such as **ثبت درخواست خرید** or **تماس سریع** as canonical labels. This clarifies text only and does not change the screenshot's authority over placement, proportions, visual hierarchy, color treatment, or spacing.
